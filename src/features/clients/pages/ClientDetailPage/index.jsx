...
import {
    ...
    DocumentInfo, DocumentMeta, DocumentDownloadButton,
    BankCard, EmptyState, EmptyText,
    SkeletonBar, SkeletonCard, Divider, FileNameText,
} from './styles';
                                ...
                                <DocumentList>
                                    {documents.map((doc) => (
                                        <DocumentItem key={doc.id}>
                                            ...
                                            <DocumentInfo style={{ flex: 1, minWidth: 0 }}>
                                                <FileNameText title={doc.original_name || 'Documento'}>
