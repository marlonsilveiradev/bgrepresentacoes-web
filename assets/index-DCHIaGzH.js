import{a,p as R,u as L,b as N,r as g,B as W,g as _,j as e,U,d as D}from"./index-zkwjf7w4.js";import{u as Y}from"./useQuery-DMChGpeS.js";import{U as I}from"./user-plus-BRE61ypy.js";import{S as M,C as J,a as q}from"./search-BggEPVkl.js";const v=R`
...
`,S=a(w)`
  color: ${({theme:t})=>t.text.secondary};
`,C={pending:{bg:"#fef3c7",color:"#92400e"},analysis:{bg:"#dbeafe",color:"#1e40af"},approved:{bg:"#d1fae5",color:"#065f46"}},st=a.span`
  display: inline-flex;
  align-items: center;
  gap: 5px;
  padding: 3px 10px;
...
`,lt={pending:"Pendente",analysis:"Em análise",approved:"Aprovado"},ct=a.div`
  display: flex;
  flex-direction: column;
  align-items: center;
